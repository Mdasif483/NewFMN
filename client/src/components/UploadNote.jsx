...
const UploadNote = () => {
  ...
  const userId = user?.user?._id; // user._id change into user?.user?._id
  ...
  const submitFile = async (e) => {
    try {
      ...
      formData.append("fileName", title); // title changend fileName
      formData.append("fileDescription", description); // descripion change into fileDescription
      formData.append("tags", tags);
      formData.append("files", file); // file change into files
      formData.append("uploadedBy", userId); // userId changed into uplodadedBy

      // console.log(formData);   // my code

      console.log("FormData: ", [...formData]);

      // console.log("Redux User: ", user);   //chatgpt
      // console.log("UserId: ", userId);  //chat gpt
